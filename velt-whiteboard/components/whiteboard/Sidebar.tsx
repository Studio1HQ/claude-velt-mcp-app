...
export function Sidebar() {
  ...
  return (
    <aside className="absolute left-0 top-0 h-full w-64 bg-background border-r border-gray-200 shadow-lg z-10 flex flex-col">
      {/* Header */}
      <div className="flex items-center justify-between p-4">
        <h2 className="text-lg font-semibold text-foreground">Shapes</h2>
        <button
          onClick={handleClose}
          ...
          {shapes.map((shape) => {
            ...
            return (
              <div
                ...
                className={`group cursor-pointer bg-card border-2 rounded-lg p-4 hover:border-blue-400 hover:shadow-md transition-all flex flex-col items-center gap-2 ${
                  selectedShape?.type === shape.type
                    ? "border-red-400 bg-blue-50"
                    : "border-none"
                }`}
